...
export interface Tutor { id: string; name: string; department: string; subjects: string[]; hourlyRate: number; availability: string; avatar: string; universityId: string; }
